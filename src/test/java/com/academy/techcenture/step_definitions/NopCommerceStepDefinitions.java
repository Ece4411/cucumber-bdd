...
public class NopCommerceStepDefinitions {
    ...
    @When("user uses login credentials {string} and {string} clicks on login button")
    public void user_uses_login_credentials_and_clicks_on_login_button(String username, String password) {
